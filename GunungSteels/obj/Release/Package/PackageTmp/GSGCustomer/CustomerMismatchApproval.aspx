<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerMismatchApproval.aspx.cs" Inherits="GunungSteels.GSGCustomer.CustomerMismatchApproval" %>
...
<body>
         <div id="modal_dialog" style="display: none">
            The information is sent to GSG team.
        </div>
    <div>
      ...
      <div  >
        ...
        <div class="col-md-6" style="height: 70px;">
            <label style="padding: 25px 20%; float: left;"><b>CUSTOMER ORDER REGISTRATION</b></label>
        ...
        <div class="col-md-12 container content" >
            ...
            <div class="col-md-6">
                    ...
                    <div class="box-body">
                         <div class="form-group">
                            ...
                            <div class="col-md-8 pull-right">
                                <label>Customer Mismatch Approval </label>
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="txt_MatchSalesOrder_Id" runat="server" Visible="false"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="txtMatchDeliveryOrderId" runat="server" Visible="false"></asp:TextBox>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="txt_MatchUom" runat="server" ReadOnly="true"></asp:TextBox>
                        ...
                        <div class="form-group">
                            <div class="col-md-4">
                                <label>Total Quantity (Tonnage/No. Of Pieces)</label>
                            </div>
                            <asp:TextBox ID="txtTotalQuantity" runat="server" ReadOnly="true"></asp:TextBox>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtMatchTotalQuantity" runat="server" ReadOnly="true"></asp:TextBox>
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" runat="server" ErrorMessage="Quantity Should Not be blank" ControlToValidate="txtTotalQuantity"></asp:RequiredFieldValidator>--%>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="txt_MatchTransporter_Name" runat="server" ReadOnly="true"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="txt_MatchSource" runat="server" ReadOnly="true"></asp:TextBox>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="txt_MatchVehicleNumber" runat="server" ReadOnly="true"></asp:TextBox>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-4">
                            <asp:TextBox ID="txt_MatchVehicleDetails" runat="server" ReadOnly="true"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="txt_MatchDriverName" runat="server" ReadOnly="true"></asp:TextBox>
                         ...
                         <div class="form-group" style="display:none;">
                           ...
                           <div class="col-md-4">
                           <asp:TextBox ID="txtMatchDriverID" runat="server" ReadOnly="true"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                 <asp:TextBox ID="txt_MatchDriver_Contact_No" runat="server" ReadOnly="true"></asp:TextBox>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-4">
                                <asp:TextBox ID="txt_MatchKTP" runat="server" ReadOnly="true"></asp:TextBox>
                       ...
                       <%--  <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txt_Authorized_By" runat="server" ReadOnly="true"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" Display="Dynamic" runat="server" ErrorMessage="Authorized by Mandatory" ControlToValidate="txt_Authorized_By"></asp:RequiredFieldValidator>
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="col-md-6">
                                    <label>Authorization Contact Number</label>
                                </div>
                                <div class="col-md-6">
                                    <asp:TextBox ID="txt_Authorization_Contact_No" runat="server" ReadOnly="true"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" Display="Dynamic" ErrorMessage="Authorization Contact Number Should Not be Blank" ControlToValidate="txt_Authorization_Contact_No"></asp:RequiredFieldValidator>
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="col-md-6">
                                    <label>Authorization Mail</label>
                                </div>
                                <div class="col-md-6">
                                    <asp:TextBox ID="txt_Authorization_Mail" runat="server" ReadOnly="true"></asp:TextBox>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="Dynamic" ErrorMessage="Mail Should not be blank" ControlToValidate="txt_Authorization_Mail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                </div>
                            </div>--%>
                        ...
                        <asp:Button ID="Button2"  runat="server" Text="Approve" CssClass="btn btn-success" 
                                onclick="Approve" />
                         
                         <asp:Button ID="Button1" runat="server" Text="Reject" CssClass="btn btn-danger" 
                                onclick="Reject"/>
                           </div>   
                ...
                <p style="padding: 11px 5px 0px 1px;">
                    <b>NOTE: Highlighted fields are Mis-match fields.Kindly validate for the same. 
                    </b>
                </p>
            </div>
