<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerDashboard.aspx.cs" Inherits="GunungSteels.Home.CustomerDashboard" %>
...
<head id="Head1" runat="server">
   ...
   <%-- <script src="http://kendo.cdn.telerik.com/2018.1.117/js/kendo.all.min.js" type="text/javascript"></script>--%>
...
<body>
    ...
    <div class="col-md-12 container content">
       ...
       <%-- <div class="col-md-3 pull-right">
            <asp:HyperLink ID="HyperLink1" runat="server" CssClass="active" NavigateUrl="../../PRVSSecurity/SecurityGateScan.aspx"
                Font-Underline="true">Go To Security Gate Access URL </asp:HyperLink></br>
            <asp:HyperLink ID="HyperLink2" CssClass="active" runat="server" NavigateUrl="../../PRVSRegistration/Registration.aspx"
                Font-Underline="true">Go To Registration Team Access URL </asp:HyperLink></br>
            <asp:HyperLink ID="HyperLink3" CssClass="active" runat="server" NavigateUrl="../../PRVSSecurity/WarehouseVehicleScan.aspx"
...
<ItemStyle Width="100px"></ItemStyle>
            ...
            <asp:BoundField DataField="SALES_TEAM_NAME" HeaderText="Sales Pic Name" 
                ItemStyle-Width="40"  >
<ItemStyle Width="100px"></ItemStyle>
            </asp:BoundField>
